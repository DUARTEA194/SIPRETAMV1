...
document.addEventListener('DOMContentLoaded', function () {
  /*$('#table_venta').DataTable({
    ajax: {
      url: 'controllers/ventasController.php?option=listar',
      dataSrc: ''
    },
    columns: [
      { data: 'codigo' },
  ...
  axios.post('controllers/ventasController.php?option=listar')
  ...
  table_clientes = $('#table_clientes').DataTable({
    ajax: {
      url: 'controllers/ventasController.php?option=listar-clientes',
      dataSrc: ''
    },
    columns: [
      { data: 'nombre' },
...
function temp() {
  axios.get('controllers/ventasController.php?option=listarTemp')
    .then(function (response) {
      const info = response.data;
      let tempProductos = '';
      info.forEach(pro => {
